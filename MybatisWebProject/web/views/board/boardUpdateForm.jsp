...
<form action="/testm/bupdate" method="post" enctype="multipart/form-data">
</c:if><c:if test="${b.boardLevel ne 0}">
<form action="/testm/brupdate" method="post">
</c:if>
...
<table align="center">
	...
	<tr><td>첨부파일</td><td><a href="/testm/bfdown?ofile=<%= b.getBoardOriginalFileName() %>&rfile=<%= b.getBoardRenameFileName() %>"><%= b.getBoardOriginalFileName() %></a></td></tr>
	<% } %>
	<tr><td>첨부파일</td><td><input type="file" name="upfile"></td></tr>
	<% } %>	
	<tr><td colspan="2" align="center">
...
<h4 align="center"><a href="/testm/blist?page=<%= currentPage %>">목록</a></h4> --%>
